...
if [ $stage -le -3 ] && $train_tree; then
  ...
  cluster-phones --pdf-class-list=${pdf_class_list} $cluster_phones_opts $context_opts $dir/treeacc $lang/phones/sets.int $dir/questions.int 2>$dir/log/questions.log || exit 1;
